import { assertBoolean, assertCoordinates, assertNumber, assertWaypoints, MAX_CONTROL_POINTS } from '../../shared/runtime-validation'
import { sampleRoute } from '../../shared/gpx'
