/**
 * Standalone DeviceManager — uses standalone broadcast + AdbService.
 */
...
export class DeviceManager {
  ...
  get adbService(): AdbService { return this.adb }
  getDevices(): DeviceInfo[] { return this.devices }
  getActiveDevice(): string | null { return this.activeDevice }
  setActiveDevice(serial: string | null): void { this.activeDevice = serial }
  ...
  async forcePoll(): Promise<void> {
    ...
    log('info', '[DeviceManager] forcePoll triggered')
